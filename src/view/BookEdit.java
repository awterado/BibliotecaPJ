...
//        taDescricao.setEnabled(false);
        ...
        btEditar.setBounds(100, 390, 100, 25);
    ...
    private void setEvents() {
        btEditar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (c.atualizar(Integer.parseInt(tfId.getText()), tfTitulo.getText(), tfEditora.getText(),tfAutor.getText(), taDescricao.getText(),tfAno.getText())) {
                    Book b = new Book();
                    JOptionPane.showMessageDialog(null, "Lívro editado!");
                } else {
                    JOptionPane.showMessageDialog(null, "Lívro não editado!");
                }
